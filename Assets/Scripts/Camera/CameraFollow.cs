...
public class CameraFollow : MonoBehaviour {
	...
	void Update () {
		...
		float posY = Mathf.SmoothDamp(transform.position.y, player.transform.position.y+2.5f, ref velocity.y, smoothTimeY);
	...
	void oldCode() {
		...
		case 1:
			...
			break;
		default:
			transform.position = new Vector3(posX, posY+2.5f, transform.position.z);
